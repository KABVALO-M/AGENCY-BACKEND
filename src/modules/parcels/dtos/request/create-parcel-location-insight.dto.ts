...
export class CreateParcelLocationInsightDto {
  ...
  @ApiProperty({
    ...
    example: 'New highway interchange approved',
  })
  @IsString()
  @MaxLength(200)
  title: string;
  ...
  @ApiProperty({
    ...
    example: 'Construction expected to drive accessibility',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiProperty({
    ...
    example: 'Ministry of Infrastructure',
  })
  @IsOptional()
  @IsString()
  @MaxLength(150)
